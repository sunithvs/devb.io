  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4">
        {userProjects?.top_languages && userProjects.top_languages.length > 0 ? (
          ...
          /* Layout when Languages are empty */
          <div className="flex flex-col gap-4">
            <div className="flex flex-col lg:flex-row gap-4">
              {user?.about && (
                <div className="bg-white rounded-xl p-6 border-1 border-black border-b-4 flex-1 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <h2 className="text-xl font-bold mb-4">🤔 About</h2>
                  <p className="text-gray-700">{user?.about}</p>
                </div>
              )}
              ...
              {user?.location && (
                <div className="bg-[#B9FF66] rounded-xl p-6 border-1 border-black border-b-4 flex-1 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <h2 className="text-xl font-bold mb-2">📍 Location</h2>
                  <p>{user?.location}</p>
                </div>
              )}
            ...
            <div className="flex gap-4 mb-8">
              ...
              {user.pull_requests_merged > 0 && (
                <div className="bg-white rounded-xl p-6 border-1 border-black border-b-4 flex-1 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                  <h2 className="font-bold mb-2">PR Merged</h2>
                  <p className="text-2xl font-bold">{user.pull_requests_merged}</p>
                </div>
              )}
            </div>
          </div>
