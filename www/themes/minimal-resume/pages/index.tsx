...
/**
 * Minimal Resume Theme - Index Page
 * Single-page resume-style portfolio
 */
export default async function MinimalResumeIndexPage({
    data,
    username
}: ThemePageProps) {
    const { profile, projects } = data;

    // Fetch LinkedIn data for experience/education
