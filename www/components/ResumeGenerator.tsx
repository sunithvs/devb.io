                ...
                <View style={styles.section}>
                    ...
                    {data.top_projects.slice(0, 3).map((project) => (
                        <View key={project.name} style={styles.section}>
                            <Text style={styles.itemTitle}>{project.name} | <Link style={styles.link} src={project.url}>Github</Link> {project.preview_url && <>| <Link style={styles.link} src={project.preview_url}>Link</Link></>}</Text>
                ...
                <View style={styles.section}>
                    ...
                    {data.linkedin_profile.education.slice(0, 1).map((education, index) => (
                        <View key={index} style={styles.section}>
                            ...
                            <Text style={styles.text}>{education.duration.start.year} - {education.duration.end?.year || 'Present'}</Text>
                        </View>
                    ))}
                </View>)}
            <View style={styles.section}>
