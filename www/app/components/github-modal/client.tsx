        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-1 justify-center items-center">
              <button
                onClick={() => {window.open('https://github.com/sunithvs/devb.io/', '_blank')}}
                className="justify-center bg-[#CCFF00] text-black px-6 py-3 rounded-lg font-semibold hover:bg-[#b8e600] transition-colors"
              >
                <div className="flex gap-1 justify-center items-center">
                  <svg
                    fill="currentColor"
